...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2995618870ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=emp_db&table=emp_dept">`emp_db`.`emp_dept`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=emp_db&table=emp_country">`emp_db`.`emp_country`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=emp_db&table=emp_dept_map">`emp_db`.`emp_dept_map`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=emp_db&table=EMP_DEPT_MAP">`emp_db`.`EMP_DEPT_MAP`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=emp_db&table=EMP_DEPT">`emp_db`.`EMP_DEPT`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=emp_db&table=EMP_COUNTRY">`emp_db`.`EMP_COUNTRY`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="65373725774b596c615a5a433a313c51">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `emp_country`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="emp_db" targettable="emp_dept">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `emp_dept` WHERE `emp_dept`.`EMP_DEPT` = &#039;&#039;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="emp_db" targettable="emp_dept">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `emp_dept` WHERE `emp_dept`.`EMP_DEPT` = &#039;ZAkir&#039;</span>
                        </div>
